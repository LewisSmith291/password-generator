    ...
    <>
      ...
      <div id="password-gen" className="bg-white dark:bg-gray-800 p-5 rounded-lg shadow-lg m-5 gap-1 flex flex-col w-xl">
        <div id="text-container" className="flex-row flex gap-0.5">
          ...
          <button id="copy-button" onClick={copyButton} className="flex flex-row text-nowrap justify-center items-center rounded-r-lg text-white py-2 px-3 cursor-pointer bg-blue-600 hover:bg-blue-700 active:bg-blue-800"> ⿻ Copy</button> 
        </div>
